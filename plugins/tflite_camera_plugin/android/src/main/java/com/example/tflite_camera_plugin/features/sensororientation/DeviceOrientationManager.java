...
package com.example.tflite_camera_plugin.features.sensororientation;
...
public class DeviceOrientationManager {
   ...
   * supplied {@link DeviceOrientation} value.
   *
   * <p>Returns one of 0, 90, 180 or 270.
   *
   * @param orientation The {@link DeviceOrientation} value that is to be converted
   *     into degrees.
   * @return The device's photo orientation in degrees.
   */
  public int getPhotoOrientation(@Nullable DeviceOrientation orientation) {
    int angle = 0;
  ...
  /**
   * Returns the device's video orientation in clockwise degrees based on the sensor orientation and
   * the supplied {@link DeviceOrientation} value.
   *
   * <p>Returns one of 0, 90, 180 or 270.
   *
   ...
   * @return The device's video orientation in clockwise degrees.
   */
  public int getVideoOrientation(@Nullable DeviceOrientation orientation) {
    int angle = 0;
  ...
  @Nullable
  public DeviceOrientation getLastUIOrientation() {
  ...
  void handleUIOrientationChange() {
    DeviceOrientation orientation = getUIOrientation();
   ...
   */
  @VisibleForTesting
  DeviceOrientation calculateSensorOrientation(int angle) {
