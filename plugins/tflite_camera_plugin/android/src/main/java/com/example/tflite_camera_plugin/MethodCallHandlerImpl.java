...
import com.example.tflite_camera_plugin.features.CameraFeatureFactoryImpl;
...
final class MethodCallHandlerImpl implements MethodChannel.MethodCallHandler {
  interface FlutterAssetGetter {
    String androidFilePathFromFlutterAssetName(String assetName);
  }
  ...
  private final EventChannel predictionsStreamChannel;
  private final FlutterAssetGetter flutterAssetGetter;
  ...
  MethodCallHandlerImpl(
    ...
    FlutterAssetGetter flutterAssetGetter
  ) {
    ...
    this.flutterAssetGetter = flutterAssetGetter;

    methodChannel = new MethodChannel(messenger, "TFLiteCamera");
    imageStreamChannel = new EventChannel(messenger, "TFLiteCameraImageStream");
    predictionsStreamChannel = new EventChannel(messenger, "TFLitePredictionsStream");
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull final Result result) {
    switch (call.method) {
      case "initTFLiteModel": {
        try {
          camera.initTFLiteSession(
            flutterAssetGetter.androidFilePathFromFlutterAssetName(
              call.argument("modelAssetPath")
            )
          );
          result.success(null);
        } catch (Exception e) {
      ...
      case "startTFLiteSessionPredictionStream" : {
        try {
          camera.startTFLiteModelPredictions(predictionsStreamChannel);
          result.success(null);
        } catch (Exception e) {
          handleException(e, result);
        }
      ...
      case "takePictureAndPredictWithTFLite" : {
        try {
          camera.takePictureAndPredict(result);
        } catch (Exception e) {
          handleException(e, result);
        }
        break;
      }
      case "stopTFLiteSessionPredictionStream" : {
        try {
          camera.startPreview();
          result.success(null);
        } catch (Exception e) {
      ...
      case "disposeTFLiteModel" : {
        try {
          camera.disposeTFLiteSession();
        } catch (Exception e) {
          handleException(e, result);
        }
        break;
