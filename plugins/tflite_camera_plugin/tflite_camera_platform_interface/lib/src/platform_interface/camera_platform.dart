...
abstract class CameraPlatform extends PlatformInterface {
  ...
  /// Captures an image, infers on it with the currently active TFLite
  /// session and returns this image's bytes and corresponding predictions.
  Future<PredictionCapture> takePictureAndPredict(int cameraId) {
  ...
  Stream<List<Map<Object?, Object?>>> onPredictionAvailable() {
    throw UnimplementedError('onPredictionAvailable() is not implemented.');
  }
  ...
  Future<void> initTFLiteModel(
    ...
    throw UnimplementedError('initTFLiteWithModel() is not implemented.');
  }

  Future<void> disposeCurrentTFLiteModel() {
    throw UnimplementedError('disposeCurrentTFLiteModel() is not implemented.');
  }
